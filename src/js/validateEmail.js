export default function validateEmail(){
    ...
    form.addEventListener('submit', e =>{
        ...
        if (!isEmail(emailValue) || isEmailEmpty(emailValue)){
            ...
            alertIcon.classList.add('icon-notification--invalid');
    ...
    function setClass(){
        ...
        if (alertIcon.className != 'icon-notification'){
            alertIcon.className = 'icon-notification';
        }
    }
